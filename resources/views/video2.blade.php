	                ...
	                <div class="site-header-shown">
	                    ...
	                    <div class="dropdown user-menu">
	                        ...
	                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dd-user-menu">
	                            ...
	                            <a class="dropdown-item" href="application"><span class="font-icon glyphicon glyphicon-log-out"></span>Logout</a>
	                        </div>
	                    </div>
	...
	<nav class="side-menu">
	    <ul class="side-menu-list">
	        ...
	        <li class="red with-sub">
	            <span>
	                <i class="font-icon font-icon-dashboard"></i>
	                <span class="lbl">Videos</span><span class="label label-custom label-pill label-danger">new</span>
	            </span>
	            <ul>
	                <li><a href="video1"><span class="lbl">Video 1</span></a></li>
	                <li><a href="video2"><span class="lbl">Video 2</span></a></li>
	                <li><a href="video3"><span class="lbl">Video 3</span></a></li>
	            </ul>
	        </li>
	...
	<div class="page-content">
	    <div class="container-fluid">
	        <div >
	            <center>
	            <div>
	            	<h3>[MV] _Ailee (에일리) –첫눈처럼 너에게 가겠다 (I will go to you like the first snow) - [도깨비 OST] Part 9</h3>
	            	<iframe width="560" height="315" src="https://www.youtube.com/embed/3fjdED2RqKQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	            </div><br><br>
	            <div>
	            	<h3>[MV] 먼데이 키즈(Monday Kiz), 펀치(Punch) - Another Day (Hotel Del Luna (호텔 델루나) OST Part.1)</h3>
	            	<iframe width="560" height="315" src="https://www.youtube.com/embed/nVCTGPcsgPI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	            </div><br><br>
	            <div>
	            	<h3>Loco (로꼬) , Punch (펀치) - Say Yes FMV (Moon Lovers OST Part 2)[Eng Sub+Rom+Han]</h3>
	            	<iframe width="560" height="315" src="https://www.youtube.com/embed/G3vN4FjEOi0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	            </div>
	             </center>
